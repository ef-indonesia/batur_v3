...
import com.traceon.batur.ui.visit.FrequentAdapter
import com.traceon.batur.ui.visit.InputVisitActivity
...
@AndroidEntryPoint
class VisitActivity : BaseActivity<ActivityVisitBinding, ViewModel>() {
    ...
    override fun init() {
        ...
        adapter = VisitAdapter(listVisit) { vi ->
